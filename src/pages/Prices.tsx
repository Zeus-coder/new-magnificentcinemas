      ...
      <section className="shell">
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-12">
          <div className="md:col-span-7">
            ...
            <Link
              to="/contact"
              className="mt-7 inline-flex items-center gap-2 border border-line-control px-6 py-3 text-sm transition-colors duration-200 hover:border-gold hover:text-gold"
